...
public class DanhSachThuTienActivity extends Activity implements Serializable {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_danh_sach_thu_tien);
    ...
    private void addEvents() {
        ...
        btnThem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(DanhSachThuTienActivity.this, BangThuActivity.class));
            }
        });
    }
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        switch (id){
            case R.id.mnuchitiet:
                Intent intent1 = new Intent(DanhSachThuTienActivity.this,ChiTietActivity.class);
                intent1.putExtra("chitiet",adapter.getItem(pos));
                startActivity(intent1);
                break;
            case R.id.mnuedit:
                Intent intent = new Intent(DanhSachThuTienActivity.this,EditActivity.class);
            ...
            case R.id.mnudelete:
                ...
                if (mainDanhSach.getLoai().equals("Thu")){
                    Toast.makeText(DanhSachThuTienActivity.this,"-"+mainDanhSach.getSotien(), Toast.LENGTH_SHORT).show();
